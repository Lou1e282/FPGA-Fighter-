module top_twoplayers (
   ...
   // ------------------------------------------------------------
    ...
    wire [11:0] final_rgb =
        game_over_on ? game_over_rgb :
        p1_hp_region ? p1_hp_rgb :
        p2_hp_region ? p2_hp_rgb :
        (sw_hitbox && p1_atk_edge)  ? 12'h0F0 :
        (sw_hitbox && p2_atk_edge)  ? 12'h0F0 :
        (sw_hitbox && p1_hurt_edge) ? 12'hF00 :
        (sw_hitbox && p2_hurt_edge) ? 12'hF00 :
